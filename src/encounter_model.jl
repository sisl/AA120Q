...
sample_initial(model::abstract type EncounterModel end) = error("sample_initial not implemented for EncounterModel $model") # should return A, C1, C2, s1 and s2 at t=0 sampled from the model
...
function Base.rand(model::EncounterModel, params::EncounterSimParams)
    ...
    Encounter(params.Δt, trace1, trace2)
end